...
import { DoorClosedIcon, Home, LogOut, Package, PanelBottom, Settings2, ShoppingBag, Users } from 'lucide-react'
        ...
        <div className="sm:hidden flex flex-col sm:gap-4 sm:py-4 sm:pl-14">
            ...
            sm:h-auto sm:border-0 sm:bg-transparent sm:px-6'>
                <Sheet>
                    ...
                    <SheetContent className='sm:max-w-xl p-4' side="left">
                        <nav className='grid gap-6 text-lg font-medium'>
                            ...
                            <Link 
                                href="#"
                                className='flex gap-4 items-center px-2.5 text-muted-foreground hover:text-foreground'  
                                prefetch={false}
                            >
